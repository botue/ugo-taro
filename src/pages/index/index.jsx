...
import { View, Image, Navigator, Swiper, SwiperItem } from '@tarojs/components'
  ...
  render () {
    return (
      <View style={{overflow: 'hidden', height: this.state.pageHeight}}>
        ...
        {/* 主导航 */}
        <View className="navs">
          <Navigator openType="switchTab" url="">
        ...
        <View className="floors">
          ...
          <View className="floor">
            <View className="title">
              <Image src="http://static.botue.com/ugo/uploads/pic_floor02_title.png"></Image>
            </View>
            <View className="items">
              <Navigator url="/pages/list">
